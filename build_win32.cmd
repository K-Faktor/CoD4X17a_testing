...
echo Linking...
gcc -Wl,--dynamic-list=pluginExports.ld -g -o cod4x17a_dedrun *.o win32/win_cod4.res -L./ -ltomcrypt_win32 -ltommath_win32 -lpthread -lm -lws2_32 -lwsock32 -lgdi32 -mwindows -lwinmm
