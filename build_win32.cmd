...
echo Linking...
gcc -g -Wl,--image-base,0x8040000 -Tlinkerscript_win32.ld -o bin/cod4x17a_dedrun bin/*.o src/win32/win_cod4.res -Llib/ -ltomcrypt_win32 -ltommath_win32 -lm -lws2_32 -lwsock32 -lgdi32 -mwindows -lwinmm
echo Cleaning up...
cd bin
del *.o
