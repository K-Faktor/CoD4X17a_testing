...
nasm -f coff pluginexports.asm -dWin32 --prefix _

echo Linking...
gcc -g -o cod4x17a_dedrun *.o win32/win_cod4.res -L./ -ltomcrypt_win32 -ltommath_win32 -lm -lws2_32 -lwsock32 -lgdi32 -mwindows -lwinmm
echo Cleaning up...
del *.o
