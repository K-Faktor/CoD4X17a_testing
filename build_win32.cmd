...
echo Compiling NASM...
nasm -f coff qcommon_hooks.asm         --prefix _ -o bin/qcommon_hooks.o
nasm -f coff cmd_hooks.asm             --prefix _ -o bin/cmd_hooks.o
nasm -f coff filesystem_hooks.asm      --prefix _ -o bin/filesystem_hooks.o
nasm -f coff xassets_hooks.asm         --prefix _ -o bin/xassets_hooks.o
nasm -f coff trace_hooks.asm           --prefix _ -o bin/trace_hooks.o
nasm -f coff misc_hooks.asm            --prefix _ -o bin/misc_hooks.o
nasm -f coff scr_vm_hooks.asm          --prefix _ -o bin/scr_vm_hooks.o
nasm -f coff g_sv_hooks.asm            --prefix _ -o bin/g_sv_hooks.o
nasm -f coff server_hooks.asm          --prefix _ -o bin/server_hooks.o
nasm -f coff msg_hooks.asm             --prefix _ -o bin/msg_hooks.o
nasm -f coff pluginexports.asm -dWin32 --prefix _ -o bin/pluginexports.o
